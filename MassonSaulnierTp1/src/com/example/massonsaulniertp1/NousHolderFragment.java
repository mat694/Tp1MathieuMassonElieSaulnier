...
public class NousHolderFragment extends Fragment {
	/**
	 ...
	 */
	public static NousHolderFragment newInstance(int sectionNumber) {
		NousHolderFragment fragment = new NousHolderFragment();
